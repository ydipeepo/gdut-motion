...
static func can_convert(value: Variant, array_size: int) -> bool:
	match typeof(value):
		TYPE_INT when _can_convert_from_int(value, array_size):
			return true
		TYPE_STRING when _can_convert_from_string(value, array_size):
			return true
		...
		TYPE_VECTOR4I when _can_convert_from_vector4i(value, array_size):
			return true
		TYPE_COLOR when _can_convert_from_color(value, array_size):
			return true
		TYPE_STRING_NAME when _can_convert_from_string_name(value, array_size):
			return true
...
static func _can_convert_from_string(
	value: String,
	array_size: int) -> bool:
...
@warning_ignore("unused_parameter")
static func _can_convert_from_color(
	value: Color,
	array_size: int) -> bool:

	return array_size == 1

static func _can_convert_from_string_name(
	value: StringName,
	array_size: int) -> bool:
