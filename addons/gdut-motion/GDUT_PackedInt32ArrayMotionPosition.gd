...
static func can_convert(value: Variant, array_size: int) -> bool:
	var can_convert: Callable = _packed_int32_array_can_convert_map.get(typeof(value))
	return can_convert.is_valid() and can_convert.call(value, array_size)

func set_value(value: Variant) -> void:
	var convert: Callable = _packed_int32_array_convert_map.get(typeof(value))
...
static func _convert_from_float(value: float) -> float:
	return roundf(value)
=======
static var _packed_int32_array_can_convert_map: Dictionary[int, Callable] = {
...
static var _packed_int32_array_convert_map: Dictionary[int, Callable] = {
...
static func _convert_from_array(array: Array, converted_array: PackedFloat32Array) -> void:
	var write := 0
	for value: Variant in array:
		match typeof(value):
			TYPE_INT:
