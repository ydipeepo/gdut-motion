class_name GDUT_Vector2iMotionPosition extends GDUT_MotionPosition

#-------------------------------------------------------------------------------
#	CONSTANTS
#-------------------------------------------------------------------------------

const DEFAULT_VALUE := Vector2i.ZERO
...
static func _can_convert_from_array(value: Array) -> bool:
	if value.size() != 2:
=======
static var _vector2i_can_convert_map: Dictionary[int, Callable] = {
...
static var _vector2i_convert_map: Dictionary[int, Callable] = {
...
static func _convert_from_float(value: float) -> Vector2:
	return Vector2(value, value).round()
